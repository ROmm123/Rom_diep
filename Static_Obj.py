...
class StaticObject():
    def _init_(self, setting, map_width, map_height, x, y, HeldAbility, damage, width_ract, height_ract):
...
class StaticObjects():
    def _init_(self, setting, map_width, map_height, crate_positions, damage_list):
